 ...
 * This is a significantly faster version of the cubecell GPS implementation. Great for proving coverage.
 */
...
#define GPS_CONTINUE_TIME 3000
#define MOVING_UPDATE_RATE 0          //in addition to GPS_CONTINUE_TIME
#define STOPPED_UPDATE_RATE 0         //In addition to GPS_CONTINUE_TIME
#define SLEEPING_UPDATE_RATE 43200000 //Update every 6hrs when sleeping
...
float batteryLevel;
int gps_continue_time = GPS_CONTINUE_TIME;
static void prepareTxFrame(uint8_t port)
{
  ...
  */
    ...
    while ((millis() - start) < GPS_UPDATE_TIMEOUT && Air530.location.age() >= 1000)
    {
    ...
    if ((lat == 0) && (lon == 0))
    {
        ...
        gps_continue_time = 10000;
        String a = Air530.getAll();
        if (a != "0")
        {
            Serial.println(a);
        }
